...
<!--======================================
        ...
        <section class="login-area pt-80px pb-80px position-relative">
                    ...
                    <div class="card-body row p-0">
                        <div class="col-lg-6">
                            <div class="form-content py-4 pr-60px pl-60px border-right border-right-gray h-100 d-flex align-items-center justify-content-center">
                                <img src="{{ asset('disilab/images/undraw-remotely.svg')}}" alt="Image" class="img-fluid">
                            </div>
                        </div><!-- end col-lg-6 -->
                        <div class="col-lg-5 mx-auto">
                            <div class="form-action-wrapper py-5">
                                <div class="form-group">
                                    <h3 class="fs-22 pb-3 fw-bold">Log in to Dice Boy Script</h3>
                            ...
                            <div class="form-group d-flex align-items-center justify-content-between">
                                ...
                                <a href="{{url('password/reset')}}" class="btn-text fs-14 hover-underline fw-regular">Forgot Password?</a>
                            </div><!-- end form-group -->
                            <div class="form-group">
            ...
            <p class="text-black text-center fs-15">Don't have an account? <a href="{{url('signup')}}" class="text-color hover-underline">Sign up</a></p>
        </div><!-- end container -->
    </section>
<!--======================================
        END LOGIN AREA
