                            ...
                            <div class="filters d-flex align-items-center justify-content-between pb-4">
                                ...
                                <div class="filter-option-box w-20">
                                    <select class="select-container">
                                        ...
                                        <option value="frequent">A to Z</option>
                                        <option value="votes">Z to A </option>
                                        <option value="active">High Rating</option>
                                        <option value="unanswered">Low Rating </option>
                                    </select>
