        		...
        		<div class="row">
        			...
        			<div class="col-lg-12">
        				<ul class="nav nav-tabs generic-tabs generic--tabs generic--tabs-2 mt-4" id="myTab" role="tablist">
        					<li class="nav-item">
        						<a class="nav-link active" id="user-profile-tab" data-toggle="tab" href="#user-profile" role="tab" aria-controls="user-profile" aria-selected="true">Script list</a>
        					</li>
        					<li class="nav-item">
                              ...
                              <div class="col-lg-12">
                                     <div class="card card-item">
                                            <div class="card-body">
                                                  ...
                                                  <div class="form-group">
                                                          <label class="fs-14 text-black fw-medium lh-20">Post Description</label>
                                                  ...
                                                  <div class="form-group">
                                                          <label class="fs-14 text-black fw-medium lh-20">Post Script</label>
                                                          ...
                                                          name="script"
                                                          value="{{ old('script')}}" rows="6"></textarea>
                                                          @error('script')
                                                          <div class="alert alert-danger">{{ $message }}</div>
                                                          @enderror
                                                  </div><!-- end form-group -->
