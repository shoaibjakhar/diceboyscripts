                ...
                <ul class="nav nav-tabs generic-tabs generic--tabs generic--tabs-2 mt-4" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="user-profile-tab" data-toggle="tab" href="#user-profile"
                            role="tab" aria-controls="user-profile" aria-selected="true">Script list</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="user-profile-tab" href="{{url('all-favorite-scripts')}}"
                            role="tab" aria-controls="user-profile" aria-selected="true">Favoite Scripts</a>
                    </li>
                ...
                <div class="tab-content" id="myTabContent">
                                        ...
                                        <div id="question">
                                            ...
                                            <div class="item p-0">
                                                <div
                                                    ...
                                                    <a href="{{url('edit-script',$post->id)}}"><button
                                                            class="btn border border-gray fs-17 ml-2 bg-info text-white"
                                                            type="button" data-toggle="tooltip" data-placement="top"
                                                            title="Edit"><i class="la la-edit"></i></button></a>

                                                    <a href="{{url('delete-script',$post->id)}}"
                                                        onclick="return confirm('Do YOu want to Delete Script?')"><button
                                                            class="btn border border-gray fs-17 ml-2 bg-danger text-white"
                                                            type="button" data-toggle="tooltip" data-placement="top"
                                                            title="Delete"><i class="la la-trash"></i></button></a>
                                                </div><!-- end media -->
                                            </div><!-- end item -->
                                            @endforeach
                                            @endif
                    ...
                    <div class="tab-pane fade" id="user-activity" role="tabpanel" aria-labelledby="user-activity-tab">
                        <div class="user-panel-main-bar">
                            ...
                            <div class="container">
                                <div
                                    class="filters pb-40px d-flex flex-wrap align-items-center justify-content-between">
                                    <h3 class="fs-22 fw-medium mr-0">Add new Script</h3>
                                </div><!-- end filters -->
                                ...
                                @endif
                                <form action="{{url('addpost')}}" class="row" method="post">
                                    @csrf
                                    <div class="col-lg-12">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input
                                                        ...
                                                        type="text" name="title" placeholder="Enter Script title"
                                                        value="{{ old('title')}}">
                                                    @error('title')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea
                                                        ...
                                                        name="script" value="{{ old('script')}}" rows="6"></textarea>
                                                    @error('script')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div><!-- end form-group -->
